...
_`*` While Who's On First does includes an optional [API](https://github.com/orgs/whosonfirst/repositories?q=api&type=all&language=&sort=) it is not currently hosted online._
...
<em>NOTE: The <a href="https://en.wikipedia.org/wiki/Whisky_War">Hans Island</a> disputed between Canada and Denmark has been resolved and needs to be updated. Huzzah diplomacy!</em>
