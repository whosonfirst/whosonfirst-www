	...
	var visualizations = [
		{
			...
			curl: "curl -X GET 'https://whosonfirst-api.mapzen.com/?method=whosonfirst.places.getDescendants&id=85899637&extras=geom:&api_key=your-mapzen-api-key'",
			...
			curl: "curl -X GET 'https://whosonfirst-api.mapzen.com/?method=whosonfirst.places.getDescendants&id=85869245&extras=geom:&api_key=your-mapzen-api-key'",
			...
			curl: "curl -X GET 'https://whosonfirst-api.mapzen.com/?method=whosonfirst.places.getDescendants&id=102026327&extras=geom:,mz:uri&api_key=your-mapzen-api-key'",
			...
			curl: "curl -X GET 'https://whosonfirst-api.mapzen.com/?method=whosonfirst.places.getDescendants&id=85922583&extras=geom:,mz:uri&api_key=your-mapzen-api-key'",
